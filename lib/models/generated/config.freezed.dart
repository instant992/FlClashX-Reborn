...
as String,overrideProviderSettings: null == overrideProviderSettings ? _self.overrideProviderSettings : overrideProviderSettings // ignore: cast_nullable_to_non_nullable
as bool,overrideNetworkSettings: null == overrideNetworkSettings ? _self.overrideNetworkSettings : overrideNetworkSettings // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson) final  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.customUserAgent = '', this.overrideProviderSettings = false, this.overrideNetworkSettings = false}): _dashboardWidgets = dashboardWidgets;
...
@override@JsonKey() final  bool overrideProviderSettings;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,locale,const DeepCollectionEquality().hash(_dashboardWidgets),onlyStatisticsProxy,autoLaunch,silentLaunch,autoRun,openLogs,closeConnections,testUrl,isAnimateToPage,autoCheckUpdate,showLabel,disclaimerAccepted,crashlyticsTip,crashlytics,minimizeOnExit,hidden,developerMode,restoreStrategy,showTrayTitle,customUserAgent,overrideProviderSettings,overrideNetworkSettings]);
